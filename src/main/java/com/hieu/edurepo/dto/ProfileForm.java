...
/**
 * Đối tượng truyền dữ liệu (DTO) biểu mẫu chỉnh sửa thông tin hồ sơ cá nhân của người dùng.
 * <p>
 * Lưu ý thiết kế bảo mật: Cố tình loại trừ các trường nhạy cảm (mật khẩu, quyền hạn role, email, avatarKey)
 * để ngăn chặn hoàn toàn nguy cơ tấn công Mass Assignment.
 * </p>
 */
